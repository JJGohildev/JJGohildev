...
# Hi, I'm Jaydipsinh Gohil 👋

### Data Analyst | Business Intelligence | KPI Reporting & Automation
...
![Snowflake](https://img.shields.io/badge/Snowflake-29B5E8?style=flat-square&logo=snowflake&logoColor=ffffff)
![Jupyter](https://img.shields.io/badge/Jupyter-F37626?style=flat-square&logo=jupyter&logoColor=ffffff)

### Analytics Capabilities

`DAX` · `Power Query` · `Data Modeling` · `ETL` · `KPI Scorecards` · `Data Validation` · `Trend & Variance Analysis` · `Excel VBA` · `Reporting Automation`

## Featured BI & Analytics Projects

| Project | Business Focus | Tools |
|---|---|---|
| **Customer Experience Analytics Dashboard** | Tracks customer satisfaction, feedback patterns, service performance, KPI trends, and improvement opportunities. | Power BI, SQL, Excel |
| **Performance KPI Dashboard & Reporting Automation** | Monitors performance gaps and trends while automating recurring reports to reduce manual preparation effort. | Power BI, SQL, Power Query, Excel VBA |
| **British Airways Reviews Dashboard** | Explores customer sentiment and compares service ratings across routes, travel classes, and time periods. | Tableau, SQL, Excel |
...
I am interested in data analytics and business intelligence opportunities where I can improve decision-making through trusted data, thoughtful KPI design, and clear visual storytelling.

- 📧 [jaydipsinhgohil12@gmail.com](mailto:jaydipsinhgohil12@gmail.com)
- 💼 [linkedin.com/in/jjgohil](https://www.linkedin.com/in/jjgohil/)
- 🧑‍💻 [github.com/jjgohildev](https://github.com/jjgohildev)
